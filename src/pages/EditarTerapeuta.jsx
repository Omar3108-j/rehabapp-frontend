...
export default function EditarTerapeuta() {
  ...
  const cargarTerapeuta = async () => {
    try {
      ...
      alert("Error cargando terapeuta");
    }
    setCargando(false);
  };
  ...
  const actualizarTerapeuta = async (e) => {
    e.preventDefault();
    ...
    await TerapeutaService.actualizar(id, terapeuta);
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto bg-white rounded-xl shadow-md">
      ...
      <form onSubmit={actualizarTerapeuta} className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="mt-6 text-right">
        <button
          onClick={actualizarTerapeuta}
          className="bg-yellow-600 hover:bg-yellow-700 text-white px-5 py-3 rounded-lg flex items-center gap-2 ml-auto"
        >
